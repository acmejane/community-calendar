...
| **The Events Calendar (WordPress)** | WordPress plugin (aka "Tribe Events"). PRODID includes site name + ECP version. | lancaster | 4 |
...
### The Events Calendar (WordPress) (4 feeds)

WordPress plugin (aka "Tribe Events"). PRODID includes site name + ECP version.

**lancaster** (4): hatefreetogether, thedirt, visitdavis, visityolo_event
